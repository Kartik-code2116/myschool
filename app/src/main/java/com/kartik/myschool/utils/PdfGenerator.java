...
public class PdfGenerator {
            ...
            try {
                ...
                for (Student student : students) {
                    ...
                    if (reportPosition == 2 || reportPosition == 6 || reportPosition == 13) {
                        com.kartik.myschool.utils.pdf.GunapattrakGenerator.addGunapattrakContent(doc, ctx, school, cls, student, s1, s2);
    ...
    public static void generate(Context ctx, School school, ClassModel cls,
        ...
        new Thread(() -> {
            try {
                ...
                // --- Page 2: Gunapattrak ---
                com.kartik.myschool.utils.pdf.GunapattrakGenerator.addGunapattrakContent(doc, ctx, school, cls, student, marks, null);
                
                // --- Page 3: Descriptive ---
                // doc.newPage();
                // addDescriptiveContent(doc, ctx, school, cls, student, marks, null); // Deprecated for individual reports
    ...
    public static String strZero(int v)  { return v > 0 ? String.valueOf(v) : "-"; }
    public static String nvl(String s)   { return s != null && !s.isEmpty() ? s : "-"; }
    public static String str(int v)      { return String.valueOf(v); }
    public static String str(double v)   { return fmt(v); }
    public static String fmt(double v)   { return v==Math.floor(v)?str((int)v):String.format(Locale.getDefault(),"%.1f",v); }
    public static String safeRoll(Student s) { return s!=null&&s.rollNo!=null?s.rollNo:"0"; }
}
