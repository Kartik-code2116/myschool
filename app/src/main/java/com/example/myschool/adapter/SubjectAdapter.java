...
import com.example.myschool.databinding.ItemSubjectCardBinding;
...
public class SubjectAdapter extends RecyclerView.Adapter<SubjectAdapter.VH> {
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        ...
        b.cardSubject.setOnClickListener(v -> {
            android.content.Intent intent = new android.content.Intent(v.getContext(), com.example.myschool.SubjectUpdateActivity.class);
